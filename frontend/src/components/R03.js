          ...
          <div class="card bg-dark text-white" >
           <img src="pagebanner2.jpg" class="card-img" alt="..." style={{height: '150px', filter: 'brightness(50%)'}}/>
             <div class="card-img-overlay">
                ...
                <h1 class="card-title" style={{fontSize: '90px'}}><b>BAGS</b> <b style={{color: 'lightpink'}}>SALE</b></h1>
                <br></br>
                <br></br>
                <br></br>
             </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4" style={{marginLeft: '40px'}}>
  <div class="col" style={{maxWidth: '420px',marginLeft: '40px'}}>
    <div class="card" style={{backgroundColor:'#E0E0E0'}}>
      <br></br>
      <center>
      <h3 class="card-title"><b class="text-danger">BAG 007</b></h3>
      <br></br>
      <img src="bag2.png" class="card-img-top" alt="..." style={{maxWidth: '370px',height:'200px'}}/>
            ...
            <div class="card-header" style={{textAlign: 'left'}}>
              ...
              <br></br>
              <h6 class="card-title"><b>Total Price:&nbsp;&nbsp;</b>Rs.{6000*quantity007}.00</h6>
            </div>
  ...
  <div class="col" style={{maxWidth: '420px',marginLeft: '40px'}}>
    <div class="card" style={{backgroundColor:'#E0E0E0'}}>
      <br></br>
      <center>
      <h3 class="card-title"><b class="text-danger">BAG 008</b></h3>
      <br></br>
      <img src="bag3.png" class="card-img-top" alt="..." style={{maxWidth: '370px',height:'200px'}}/>
            <div class="card text-dark bg-light mb-3" style={{maxWidth: '370px'}}>
            <div class="card-header" style={{textAlign: 'left'}}>
              <h6 class="card-title"><b>Price:&nbsp;&nbsp;</b>Rs.4800.00</h6>
              <br></br>
              ...
              <h6 class="card-title"><b>Available Stock:</b> 5</h6>
              <br></br>
              <h6 class="card-title"><b>Total Price:&nbsp;&nbsp;</b>Rs.{4800*quantity008}.00</h6>
            </div>
  ...
  <div class="col" style={{maxWidth: '420px',marginLeft: '40px'}}>
    <div class="card" style={{backgroundColor:'#E0E0E0'}}>
      <br></br>
      <center>
      <h3 class="card-title"><b class="text-danger">BAG 009</b></h3>
      <br></br>
      <img src="bag4.png" class="card-img-top" alt="..." style={{maxWidth: '370px',height:'200px'}}/>
            <div class="card text-dark bg-light mb-3" style={{maxWidth: '370px'}}>
            <div class="card-header" style={{textAlign: 'left'}}>
              <h6 class="card-title"><b>Price:&nbsp;&nbsp;</b>Rs.5300.00</h6>
              <br></br>
              ...
              <h6 class="card-title"><b>Available Stock:</b> 5</h6>
              <br></br>
              <h6 class="card-title"><b>Total Price:&nbsp;&nbsp;</b>Rs.{5300*quantity009}.00</h6>
            </div>
      ...
      <div class="card bg-danger text-white" style={{height: '350px', width:'100%'}}>
             ...
             <div class="card-img-overlay">
              <br></br>
                <h3 class="card-title" style={{float: 'left'}}><b class="text-lignt">CONTACT</b></h3>
                <br></br>
