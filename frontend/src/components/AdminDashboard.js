...
export default function AdminDashboard() {
  ...
  return (
          ...
          <div class="card bg-dark text-white" >
           <img src="pagebanner2.jpg" class="card-img" alt="..." style={{height: '150px', filter: 'brightness(50%)'}}/>
             <div class="card-img-overlay">
                ...
                <h1 class="card-title" style={{fontSize: '90px'}}><b>ADMIN</b> <b style={{color: 'lightpink'}}>DASHBOARD</b></h1>
                <br></br>
                <br></br>
                <br></br>
             </div>
    ...
    <div class="card text-white bg-danger" style={{height:'300px',filter: 'brightness(80%)'}}>
    <br></br>
    <br></br>
    <center>
    ...
    <br></br>
    <br></br>
    <h2 class="card-title"><b class="text-white">PRODUCTS</b></h2>
    </center>
    <br></br>
    <div class="card-body">
    <Link to='/allproduct'>
    ...
    <br></br>
    <br></br>
    <h2 class="card-title"><b class="text-white">DELIVERY</b></h2>
    </center>
    <br></br>
    <div class="card-body">
    <Link to=''>
