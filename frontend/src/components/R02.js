          ...
          <div class="card bg-dark text-white" >
           <img src="pagebanner2.jpg" class="card-img" alt="..." style={{height: '150px', filter: 'brightness(50%)'}}/>
             <div class="card-img-overlay">
                ...
                <h1 class="card-title" style={{fontSize: '90px'}}><b>CAPS</b> <b style={{color: 'lightpink'}}>SALE</b></h1>
                <br></br>
                <br></br>
                <br></br>
             </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4" style={{marginLeft: '40px'}}>
  <div class="col" style={{maxWidth: '420px',marginLeft: '40px'}}>
    <div class="card" style={{backgroundColor:'#E0E0E0'}}>
      <br></br>
      <center>
      <h3 class="card-title"><b class="text-success">CAP 004</b></h3>
      <br></br>
      <img src="cap2.png" class="card-img-top" alt="..." style={{maxWidth: '370px',height:'200px'}}/>
  ...
  <div class="col" style={{maxWidth: '420px',marginLeft: '40px'}}>
    <div class="card" style={{backgroundColor:'#E0E0E0'}}>
      <br></br>
      <center>
      <h3 class="card-title"><b class="text-success">CAP 005</b></h3>
      <br></br>
      <img src="cap3.png" class="card-img-top" alt="..." style={{maxWidth: '370px',height:'200px'}}/>
            <div class="card text-dark bg-light mb-3" style={{maxWidth: '370px'}}>
            <div class="card-header" style={{textAlign: 'left'}}>
              <h6 class="card-title"><b>Price:&nbsp;&nbsp;</b>Rs.1500.00</h6>
              <br></br>
              ...
              <h6 class="card-title"><b>Available Stock:</b> 5</h6>
              <br></br>
              <h6 class="card-title"><b>Total Price:&nbsp;&nbsp;</b>Rs.{1500*quantity005}.00</h6>
            </div>
  ...
  <div class="col" style={{maxWidth: '420px',marginLeft: '40px'}}>
    <div class="card" style={{backgroundColor:'#E0E0E0'}}>
      <br></br>
      <center>
      <h3 class="card-title"><b class="text-success">CAP 006</b></h3>
      <br></br>
      <img src="cap4.png" class="card-img-top" alt="..." style={{maxWidth: '370px',height:'200px'}}/>
            <div class="card text-dark bg-light mb-3" style={{maxWidth: '370px'}}>
            <div class="card-header" style={{textAlign: 'left'}}>
              <h6 class="card-title"><b>Price:&nbsp;&nbsp;</b>Rs.2100.00</h6>
              <br></br>
              ...
              <h6 class="card-title"><b>Available Stock:</b> 5</h6>
              <br></br>
              <h6 class="card-title"><b>Total Price:&nbsp;&nbsp;</b>Rs.{2100*quantity006}.00</h6>
            </div>
