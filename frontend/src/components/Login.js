...
export default function Login() {
    ...
    return(
        ...
        <div style={{backgroundImage: `url('loginbg01.png')`}}>
        ...
        <div className="Login " >
            ...
            <div class="card text-center" style={{width: '37%'}}>
                ...
                <div class="card-body">
                <img src="navlogo.png" style={{maxHeight:'150px',width: '30%'}} alt="..."/>
                    <h1 class="card-title text-danger"><b>Login</b></h1>
                    <br></br>
                    <br></br>
                    ...
                    <form action="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control  " onChange={(e)=>{setUserName(e.target.value)}} id="username" placeholder="User Name"required/>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label " style={{float: 'left'}}><i class="fa-solid fa-lock"></i><b> Password :</b></label>
                            <input type="password" class="form-control " onChange={(e)=>{setPassword(e.target.value)}} id="password" placeholder="Password"required/>
                        </div>
                        <br></br>
                        
                        
                        <button type="submit" class="btn btn-danger" onClick={submit}>LOGIN</button>
                        <br></br>
                        <br></br>
